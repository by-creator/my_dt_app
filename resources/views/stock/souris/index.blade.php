    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-content">
                ...
                @endif
                <form method="post" action="{{route('souris.create')}}" class="form" enctype="multipart/form-data">
                    @csrf
                    <div class="row match-height">
                        @include('partials.stock.souris.form')
                        @include('partials.stock.souris.list')
                    </div>
                </form>
                @else
                @endif
