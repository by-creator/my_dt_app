...
<body>
    ...
    <div class="premium-card">
        ...
        <!-- Formulaire -->
        <form id="remiseForm" method="POST" action="{{ route('ies.remise') }}" enctype="multipart/form-data">
            @csrf
            ...
            <button type="submit" class="btn btn-gradient">ENVOYER LA DEMANDE DE REMISE</button>
        </form>
