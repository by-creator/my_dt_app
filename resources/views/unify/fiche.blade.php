            ...
            <div class="tm_invoice_content">
              ...
              <div class="tm_invoice_info tm_mb25">
                <div class="tm_invoice_info_left">
                  <p class="tm_mb17">
                    <b class="tm_f18 tm_primary_color"><u>NEPTUNE_ID</u></b> <br><br>
                    <b class="tm_f18 tm_primary_color">{{ $data['neptune_id']}}</b> <br>
                  </p>
                </div>
                <div class="tm_invoice_info_right">
                  <div class="tm_grid_row tm_col_3 tm_col_2_sm tm_invoice_info_in tm_gray_bg tm_round_border">
                    ...
                    <div>
                      <h6>IPAKI_ID</h6> <br>
                      <b class="tm_primary_color">{{ $data['ipaki_id']}}</b>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="tm_round_border">
                  <div class="tm_table_responsive">
                    <table>
                      <thead>
                        <tr>
                          <th class="tm_width_2 tm_semi_bold tm_primary_color">Informations personnelles</th>
                          <th class="tm_width_2 tm_semi_bold tm_primary_color">Informations société</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td class="tm_width_2">
                              ...
                              Raison soiciale : {{ $data['social_reason']}}
                              <br>
                              Adresse : {{ $data['address']}}
                              <br>
                              Code postal / Ville : {{ $data['city']}}
                              <br>
                              Pays : {{ $data['country']}}
                              <br>
                              Courriel : {{ $data['email']}}
                              ...
                              N° CNI : {{ $data['cni']}}
                              <br>
                              Date d'expiration : {{ $data['expiration_date']->format('d-m-Y')}}
                            
                          </td>
                          <td class="tm_width_2">
                           
                              Date de création : {{ $data['creation_date']->format('d-m-Y')}}
                              <br>
                              Forme juridique : {{ $data['juridic_form']}}
                              <br>
                              Statut juridique : {{ $data['juridic_status']}}
                              <br>
                              Ninea : {{ $data['ninea']}}
                              <br>
                              Registre de commerce : {{ $data['rc']}}
                              <br>
                              Directeur Général : {{ $data['dg']}}
                              <br>
                              Téléphone : {{ $data['dg_phone']}}
                              <br>
                              Directeur Financier : {{ $data['daf']}}
                              <br>
                              Téléphone : {{ $data['daf_phone']}}
                              <br>
