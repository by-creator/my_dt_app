...
@section('content')
    ...
    {{-- ERRORS --}}
    @if ($errors->any())
        <div class="alert alert-error" style="animation: fadeUp .4s ease both;">
    ...
    <div class="upload-card">
        <form id="convertForm" action="{{ route('edi.preview') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="drop-zone" id="dropZone">
                ...
                <div class="drop-sub">ou cliquez pour sélectionner &nbsp;·&nbsp; Format <code>.txt</code> &nbsp;·&nbsp; Max
                    <code>50 Mo</code>
                </div>
            </div>
    ...
    {{-- SPECS BAR --}}
    <div class="specs-bar"
        style="display:flex;flex-direction:row;flex-wrap:nowrap;align-items:center;gap:1rem;white-space:nowrap;overflow-x:auto;">
        <div class="spec-item">Format <strong>IFTMIN / EXCEL D04 96B UN</strong></div>
        <div class="spec-dot" style="width:3px;height:3px;background:#94A3B8;border-radius:50%;flex-shrink:0;"></div>
