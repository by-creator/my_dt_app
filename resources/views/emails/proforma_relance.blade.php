...
# Relance sur facture proforma

Bonjour,

Ceci est un message de relance.

Je me présente {{ $data['prenom'] }} {{ $data['nom'] }} et je vous relance par rapport à la facture proforma concernant le numéro de Bl ci-dessous :
