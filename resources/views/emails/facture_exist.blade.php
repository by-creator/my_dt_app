...
# Facture Définitive Indisponible

Bonjour {{ $prenom }} {{ $nom }},

Votre dossier dont voici le numéro de BL **{{ $bl }}** ne peut avoir de facture définitive pour le motif ci-dessous : 

**Motif :** {{ $motif }}
<br>
<br>

Merci de faire une demande de bon à délivrer (BAD) si nécessaire.
