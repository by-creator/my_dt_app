<form method="GET" action="{{ route('ordre_approche.index') }}" class="row g-2 mb-3">
    ...
    <div class="col-md-2 d-flex align-items-end">
        ...
        <a href="{{ route('ordre_approche.index') }}" class="btn btn-sm btn-outline-primary"><i class="fa-solid fa-rotate-right"></i> Actualiser</a>
    </div>
</form>
