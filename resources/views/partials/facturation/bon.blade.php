<section class="section">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><u>Gestion des bons à délivrer</u></h4>
        </div>
        <div class="card-body">
                    ...
                    <form id="sendBonForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="bon[]" class="form-control" multiple required>
                            </div>
        ...
        <div class="modal fade" id="rejetModal" tabindex="-1" aria-labelledby="rejetModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="rejetModalLabel">Rejet du bon à délivrer (BAD)</h5>
                        ...
                        <form id="rejectForm" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="motif" class="form-label">
                                    Êtes-vous sûr de vouloir rejeter ce BAD ?
                                </label>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        table.addEventListener('click', function(e) {
            ...
            document.getElementById("rejectForm").action = "/dossier-facturation/bon/reject/" + id;
        });
