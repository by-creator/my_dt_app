    ...
    <div id="app">
        <div id="sidebar" class="active">
            <div class="sidebar-wrapper active">
                ...
                <a href="{{ route('dashboard') }}"><img src="{{asset('templates/mazer/dist/assets/images/logo/logo.png')}}" alt="Logo" width="300" srcset=""></a>
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @include('partials.planification.menu')
                        @endif
        ...
        <div id="main">
            ...
            <div class="page-content">
                @if($user->role->name == "ADMIN" || $user->role->name == "SUPER_U" || $user->role->name == "PLANIFICATION")
                @include('partials.planification.recap_debarquement.form')
                @endif
            </div>
        </div>
    </div>
