                ...
                <div class="tm_invoice_content">
                    <div class="tm_invoice_head tm_mb30">
                        <div class="tm_invoice_left">
                            <div class="tm_logo"><img src="{{ asset('templates/site/images/logo.png') }}" alt="Logo"
                    ...
                    <div class="tm_invoice_info tm_mb25">
                        ...
                        <div class="tm_invoice_info_right">
                            <div class="tm_grid_row tm_col_3 tm_col_2_sm tm_invoice_info_in tm_gray_bg tm_round_border">
                                ...
                                <div>
                                    <h6>Document N°</h6> <br>
                                    <b class="tm_primary_color">DT-OPS-F-0010 Rév. 1</b>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tm_round_border">
                            <div class="tm_table_responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="tm_width_2 tm_semi_bold tm_primary_color">Informations sur
                                                l'ordre d'approche</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                        ...
                        <div class="tm_round_border">
                            <div class="tm_table_responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="tm_width_2 tm_semi_bold tm_primary_color">Nom Pointeur Livreur
                                            </th>
                                            <th class="tm_width_2 tm_semi_bold tm_primary_color">Responsable Livraison
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
